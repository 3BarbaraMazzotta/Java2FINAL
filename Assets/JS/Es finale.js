...
console.log(deleteOne('Barbara', false));
...
console.log(onlyLetters('Ho 1 gatto'));
...
console.log(howManyDays('2024-11-15'));
...
console.log(
  deleteProp({ name: 'Barbara', age: 30, surname: 'Mazzotta' }, 'age')
);
...
allAInRed();
console.log('trasformare tutti i background dei link in rosso');
...
console.log('Aggiungere un nuovo elemento alla lista');
